...
class PrivilegeListVerticalV3 extends StatefulWidget {
  PrivilegeListVerticalV3({Key? key, required this.site, required this.model}) : super(key: key);

  final String site;
  final Future<dynamic> model;

  @override
  _PrivilegeListVerticalV3 createState() => _PrivilegeListVerticalV3();
}

class _PrivilegeListVerticalV3 extends State<PrivilegeListVerticalV3> {
  @override
  void initState() {
    super.initState();
  }
