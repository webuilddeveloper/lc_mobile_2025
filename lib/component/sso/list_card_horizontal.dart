          ...
          children: [
            ...
            widget.userData.countUnit != ''
                ? myCard(
                    ...
                    '',
                    LinearGradient(
                        colors: [Color(0xFF9A1120), Color(0xFF0191B4)]))
                : myCardUnActivate(
                    context,
                    'ยอดเงินสมทบชราภาพ',
            ...
            myCard(
                ...
                LinearGradient(colors: [Color(0xFF0191B4), Color(0xFF9A1120)])),
            SizedBox(
              width: 5.0,
            ),
          ],
        ...
        child: ListView(
          ...
          children: [
            ...
            myCardUnActivate(
                ...
                'ยอดเงินสมทบชราภาพ',
                'กรุณาเชื่อมต่อระบบผู้ประกันตน เพื่อแสดงข้อมูล',
                LinearGradient(colors: [Color(0xFF9A1120), Color(0xFF0191B4)]),
