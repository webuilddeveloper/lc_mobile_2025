...
class ChangePasswordV4Page extends StatefulWidget {
  const ChangePasswordV4Page({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _ChangePasswordV4State createState() => _ChangePasswordV4State();
}

class _ChangePasswordV4State extends State<ChangePasswordV4Page> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: headerV4(context, goBack, title: 'เปลี่ยนรหัสผ่าน'),
