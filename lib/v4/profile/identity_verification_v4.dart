...
class IdentityVerificationV4Page extends StatefulWidget {
  IdentityVerificationV4Page({super.key, required this.title});
  String title;

  @override
  // ignore: library_private_types_in_public_api
  _IdentityVerificationV4PageState createState() =>
      _IdentityVerificationV4PageState();
}

class _IdentityVerificationV4PageState
    extends State<IdentityVerificationV4Page> {
    ...
    return FutureBuilder<dynamic>(
      ...
      builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
        if (snapshot.hasError)
          ...
          return Scaffold(
            appBar: headerV4(context, goBack, title: widget.title),
