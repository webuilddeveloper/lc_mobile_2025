...
class EventCalendarListVerticalV4 extends StatefulWidget {
  EventCalendarListVerticalV4({
    Key? key,
    required this.model,
    required this.title,
    required this.url,
  ...
  @override
  _EventCalendarListVerticalV4 createState() => _EventCalendarListVerticalV4();
}

class _EventCalendarListVerticalV4 extends State<EventCalendarListVerticalV4> {
  @override
  void initState() {
    super.initState();
  }
