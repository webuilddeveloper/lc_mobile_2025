...
class EventCalendarFormPageV4 extends StatefulWidget {
  const EventCalendarFormPageV4({super.key, this.model, @required this.code});

  final String? code;
  final dynamic model;

  @override
  State<EventCalendarFormPageV4> createState() => _EventCalendarFormPageV4State();
}

class _EventCalendarFormPageV4State extends State<EventCalendarFormPageV4> {
  dynamic model;
  int _currentImage = 0;
