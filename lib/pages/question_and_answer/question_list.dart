...
import 'package:lc/pages/question_and_answer/answer_list.dart';
import 'package:lc/pages/question_and_answer/question_form.dart';
import 'package:lc/shared/api_provider.dart';
import 'package:lc/shared/extension.dart';
import 'package:pull_to_refresh/pull_to_refresh.dart';

class BuildQuestionList extends StatefulWidget {
  BuildQuestionList({Key? key, this.menuModel, this.model, this.isSchool})
      : super(key: key);
  ...
  _onLoading() async {
    ...
    setState(() {
      _futureModel = post(questionApi + 'read',
          {'limit': _limit, 'skip': 0, 'profileCode': profileCode});
    });
