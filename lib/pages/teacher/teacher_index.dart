...
import 'package:lc/pages/teacher/teacher_list.dart';

class BuildTeacherIndex extends StatefulWidget {
  BuildTeacherIndex({Key? key, this.menuModel, this.model}) : super(key: key);
  ...
  checkNameEmpty() {
    ...
    if (textEditingController.text != '') {
      Navigator.of(context).push(
        MaterialPageRoute(
          builder: (context) =>
              TeacherList(keySearch: textEditingController.text),
        ),
      );
    } else {
      showDialog(
